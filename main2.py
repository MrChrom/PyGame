...
def Frame(imagePath):
    frame = pygame.image.load(imagePath).convert()
    frame.set_colorkey((255, 255, 255), RLEACCEL)
    # frame.rect = frame.get_rect()
    return frame

frame0 = Frame('ref/jet.000.png')
frame1 = Frame('ref/jet.001.png')
frame2 = Frame('ref/jet.002.png')
frame3 = Frame('ref/jet.003.png')
frames = [(frame0, 100), (frame1, 100), (frame2, 100), (frame3, 100)]
